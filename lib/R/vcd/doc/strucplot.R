...
###################################################
### chunk number 2: Arthritis
###################################################
mosaic(art, gp = shading_max, split_vertical = TRUE)


###################################################
### chunk number 3: UCBAdmissions
###################################################
...
###################################################
### chunk number 7: structable
###################################################
(HEC <- structable(Eye ~ Sex + Hair, data = HairEyeColor))


###################################################
### chunk number 8: Observed
###################################################
mosaic(HEC)


###################################################
### chunk number 9: Observed2
###################################################
mosaic(~ Sex + Eye + Hair, data = HairEyeColor)


###################################################
### chunk number 10: Observedfig
###################################################
mosaic(HEC)


###################################################
### chunk number 11: Expected
###################################################
mosaic(HEC, type = "expected")


###################################################
### chunk number 12: Expectedfig
###################################################
mosaic(HEC, type = "expected")


###################################################
### chunk number 13: sieve
###################################################
sieve(~ Sex + Eye + Hair, data = HEC, spacing = spacing_dimequal(c(2,0,0)))


###################################################
### chunk number 14: sievefig
###################################################
sieve(~ Sex + Eye + Hair, data = HEC, spacing = spacing_dimequal(c(2,0,0)))


###################################################
### chunk number 15: Residuals
###################################################
assoc(HEC, compress = FALSE)


###################################################
### chunk number 16: Residualsfig
###################################################
assoc(HEC, compress = FALSE)
...
###################################################
### chunk number 21: split2
###################################################
mosaic(HEC, direction = c("v","h","v"))


###################################################
### chunk number 22: doubledecker1
###################################################
doubledecker(Titanic)


###################################################
### chunk number 23: doubledecker2
###################################################
...
###################################################
### chunk number 28: Variables1
###################################################
pushViewport(viewport(layout = grid.layout(ncol = 2)))


###################################################
### chunk number 29: Variables2
###################################################
...
###################################################
### chunk number 40: viewportnamesfig
###################################################
mosaic(~ Hair + Eye, data = HEC, pop = FALSE)
...
###################################################
### chunk number 64: interpolatefig
###################################################
pushViewport(viewport(layout = grid.layout(ncol = 2)))
pushViewport(viewport(layout.pos.col = 1))
...
###################################################
### chunk number 80: boxes2
###################################################
mosaic(Titanic, labeling = labeling_cboxed)


###################################################
### chunk number 81: labbl
###################################################
...
###################################################
### chunk number 100: oc2
###################################################
structable(survival ~ ., data = tab)


###################################################
### chunk number 101: oc3
###################################################
...
###################################################
### chunk number 103: oc4
###################################################
doubledecker(survival ~ stage + operation + xray, data = tab)


###################################################
### chunk number 104: ocdoubledecker
###################################################
doubledecker(survival ~ stage + operation + xray, data = tab)


###################################################
### chunk number 105: oc6
###################################################
...
###################################################
### chunk number 107: oc7
###################################################
mosaic(tab, expected = ~ (survival + operation * xray) * stage, split_vertical = split)


###################################################
### chunk number 108: ocmosaicstage
###################################################
mosaic(tab, expected = ~ (survival + operation * xray) * stage, split_vertical = split)
